...
export const SECTIONS = ["dash", "cands", "pipeline", "jobs", "clients", "placements", "pools", "interviews", "tasks", "reports", "search", "outreach", "settings"] as const;
export type Section = (typeof SECTIONS)[number];

const ACCESS: Record<Role, Section[]> = {
  super_admin: ["dash", "cands", "pipeline", "jobs", "clients", "placements", "pools", "interviews", "tasks", "reports", "search", "outreach", "settings"],
  admin: ["dash", "cands", "pipeline", "jobs", "clients", "placements", "pools", "interviews", "tasks", "reports", "search", "outreach", "settings"],
  recruiter: ["dash", "cands", "pipeline", "jobs", "clients", "placements", "pools", "interviews", "tasks", "reports", "search", "outreach"],
